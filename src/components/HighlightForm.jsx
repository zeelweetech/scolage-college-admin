...
const HighlightForm = ({ info }) => {
   ...
   const handleFormSubmit = async () => {
      ...
      try {
         const { data } = await axios.patch(`/v2/reg/highlight/edit/${formData.highlightid}`, formData)
         setEditable(false)
         ...
         <Wrapper>
            <div className="highlight-check-main">
               {highlightCheckData.map((item, index) => (
                  <HighlightChecks key={index} data={item} name="highlight" formData={formData} highlightChecks={highlightChecks} handleCheckChange={handleCheckChange} handleDescChange={handleDescChange} setHighlightChecks={setHighlightChecks} />
               ))}
            </div>
            ...
            <div className="security-block-main">
               ...
               <textarea value={formData?.safety_security} name="safety_security" onChange={handleChange}></textarea>
            </div>
         </Wrapper>

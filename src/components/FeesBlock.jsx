...
const FeesBlock = ({ info }) => {
   ...
   const handleFormSubmit = async (e) => {
      ...
      try {
         ...
         const { data } = await axios.patch(`/v2/reg/feestrucutre/edit/${note.fee_structureid}`, newObj);
         ...
         <Wrapper>
            <div className="criteria-textarea">
               ...
               <div className="text-field">
                  <textarea name="eligibility_criteria" value={note.eligibility_criteria} onChange={handleChange}></textarea>
               </div>
            </div>
            <div className="criteria-textarea">
               <div className="title">
               ...
               <div className="text-field">
                  <textarea name="fee_terms" value={note.fee_terms} onChange={handleChange}></textarea>
               </div>
            </div>
         </Wrapper>
